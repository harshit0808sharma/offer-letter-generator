    ...
    <div className="col-span-2 order-2">
      <div className="md:rounded-xl shadow-inset overflow-hidden border border-gray-200" style={{ backgroundColor: '#FFFFFF', boxShadow: "inset 0 2px 8px rgba(0,0,0,0.3)" }}>
        ...
        >
          ...
          <h2 className="text-lg font-semibold">Offer Letter Preview - {formData.employmentType || '[Employment Type]'}</h2>
        </div>
            ...
            >
              <div className="flex-1 px-8 py-6">
                ...
                <div className="space-y-6 text-sm leading-7" style={{ color: '#1F2937' }}>
                    ...
                    <ul className="ml-6 space-y-1" style={{ listStyleType: "disc" }}>
                      {formData.whatToExpect?.map((item, index) => (
                        <ContentEditable
                          key={index}
                          innerRef={(el) => {
                            if (!fieldRefs.current.whatToExpected) fieldRefs.current.whatToExpected = [];
                            fieldRefs.current.whatToExpected[index] = el;
                          }}
                          html={item}
                          onChange={(e) => {
                            ...
                            setFormData((prev) => {
                              ...
                              updated[index] = value;
                              return { ...prev, whatToExpected: updated };
                            });
                          }}
                          tagName="li"
                          style={{ outline: "none" }}
                  ...
                  <div className="mt-8">
                    <p className="font-semibold text-lg mb-6">Terms and Conditions</p>
                  ...
                  <div className="mt-8">
                    <p>
                      ...
                      <ContentEditable
                        innerRef={(el) => (fieldRefs.current.acceptanceDeadline = el)}
                        html={
                    ...
                    <div className="pt-6 mt-8" style={{ borderTop: '2px solid #D1D5DB' }}>
                      <p className="font-semibold mb-4">Candidate Acceptance</p>
                      <p className="mb-6 whitespace-normal break-words">
